...
import PLectureScheduleAdd from './AddScheduleCompo';
import { LectureAddScheduleAPI } from '@/src/legacy/config/strings';
import { makeTimeFormat } from '@/src/legacy/lib/time';

export function AddSchedule({ navigation, route }) {
