...
import {
  DateTimeInfoType,
  MarkedDatesType,
} from '@components/Instructor/AllSchedule/types';
...
export const scheduleIdObjState = atom<ScheduleIdObjType>({
  key: 'Instructor_scheduleArrayByIdState',
  default: {},
});
...
export const selectedClassByIdSelector = selector({
  key: 'Instructor_selectedClassByIdSelector',
  get: ({ get }) => {
...
export const selectedEquipmentsIdState = atom<selectedEquipmentsStateType>({
  key: 'Instructor_selectedEquipmentsId',
  default: {
    id: 0,
    name: '',
  },
...
export const studentNumberState = atom<number>({
  key: 'Instructor_studentNumber',
  default: 1,
});

export const smallModalMessageState = atom<string>({
  key: 'Instructor_smallModalMessageState',
  default: '',
});
...
export const reservationEquipmentObjState = atom<ReservationEquipmentObjType>({
  key: 'Instructor_reservationEquipmentObjState',
  default: {},
});
...
>({
  key: 'Instructor_requestReservationEquipmentArrayState',
  default: [],
});
